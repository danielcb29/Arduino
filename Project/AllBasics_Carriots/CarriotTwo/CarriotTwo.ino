...
const String DEVICE="testdos@danielcb.danielcb";    // Replace with the id_developer of your device
...
void escribirInformacion(String id,int h, int t){
  ...
  String date = getDate();
  date.trim();
  File dataFile = FileSystem.open("/root/Proyecto/sensor.log", FILE_APPEND);
  if (dataFile) {
